...
Description of the test participants(6 test participants). (Summary of test participates info in appendix) (Hiruna, Rana0301)
...
List of specific tasks participants will perform, including tasks that utilise the back-end functionality. (150 words) (Summary of test participates info in appendix) (Saaim, saai0013)
...
These tasks demonstrated the responsivness of the website across laptops and mobile devices and evaluated the efficiency of JavaScript validation. Along with that, these tasks also showcased the overall user satisfaction with this website.


Methodology, i.e., apparatus used (e.g., pre-test demographics questionnaire, SEQ, SUS, think-aloud protocol, observations, other post-test questionnaires). (Zac, Path0171)
